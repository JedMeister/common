...
# general TKL build vars
CONF_VARS += HOSTNAME ROOT_PASS WEBMIN_THEME ARCH_FAMILY RPI
# apt repos
CONF_VARS += NONFREE TKL_TESTING BACKPORTS_NONFREE BACKPORTS
# set specific software versions
CONF_VARS += PHP_VERSION RUBY_VER NODE_VER
# Webmin/firewall related
CONF_VARS += WEBMIN_FW_TCP_INCOMING WEBMIN_FW_TCP_INCOMING_REJECT
CONF_VARS += WEBMIN_FW_UDP_INCOMING WEBMIN_FW_NAT_EXTRA WEBMIN_FW_MANGLE_EXTRA
